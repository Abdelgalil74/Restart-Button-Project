...
#define PORTB_PIN0_INIT_VALUE     PULLED_UP
#define PORTB_PIN1_INIT_VALUE     PULLED_UP
#define PORTB_PIN2_INIT_VALUE     PULLED_UP
#define PORTB_PIN3_INIT_VALUE     PULLED_UP
#define PORTB_PIN4_INIT_VALUE     PULLED_UP
#define PORTB_PIN5_INIT_VALUE     PULLED_UP
#define PORTB_PIN6_INIT_VALUE     PULLED_UP
#define PORTB_PIN7_INIT_VALUE     PULLED_UP
...
#define PORTD_PIN2_INIT_VALUE     HIGH
#define PORTD_PIN3_INIT_VALUE     HIGH
#define PORTD_PIN4_INIT_VALUE     HIGH
#define PORTD_PIN5_INIT_VALUE     HIGH
#define PORTD_PIN6_INIT_VALUE     HIGH
